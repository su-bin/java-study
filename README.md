...
- [CHAPTER-02-변수와-타입](/chapter02)
- [CHAPTER-03-연산자](/chapter03)
- [CHAPTER-04-조건문과-반복문](/chapter04)
- [CHAPTER-05-참조-타입](/chapter05)
- [CHAPTER-06-클래스](/chapter06d)
...
## CHAPTER-06-클래스
### 객체 지향 프로그래밍
- 객체 지향 프로그래밍(OOP: Object Oriented Programming) : 소프트웨어를 개발할 때 부품에 해당하는 개체들을 먼저 만들고, 이것들을 하나씩 조립해서 완성된 프로그램을 만드는 기법
- 객체의 개념과 객체의 상호작용에 대해서 알아야 한다.

#### 객체
- 객체(Object) : 물리적으로 존재하거나 추상적으로 생각할 수 있는 것 중에서 자신의 속성을 가지고 있고 다른 것과 식별 가능한 것
- 객체는 속성과 동작으로 구성되어 있다.
- 속성과 동작들을 각각 필드(field)와 메소드(method)라고 부른다.
